# 2026-07-27 15:02:00 by RouterOS 7.21.5
# software id = 3UB9-5HEV
#
# model = RB750Gr3
# serial number = CC210F9A08D3
# identity = RB750-WIREGUARD
# Export pre-noite colado pelo usuario. Contem senha FTP no script backup_ftp —
# nao copiar credenciais para docs.
/interface bridge
...
set [ find default-name=ether4 ] comment="Dell R720  HubSoft + Radius" name=\
    "ether4 - Proxmox HubSoft"
...
add dont-require-permissions=yes name=backup_ftp owner=admin policy=\
    ...
    "# REDACTED no arquivo de trabalho — ver equipamento; senha FTP nao documentar"
