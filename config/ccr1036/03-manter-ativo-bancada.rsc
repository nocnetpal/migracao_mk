...
/ip address set [find address="177.72.104.15/27"] disabled=no comment="IP PUBLICO NAT CCR"
...
/ip firewall nat set [find chain=srcnat to-addresses="177.72.104.15"] disabled=no comment="NAT GERAL"
