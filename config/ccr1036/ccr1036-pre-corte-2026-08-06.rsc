# 2026-08-06 12:17:42 by RouterOS 7.23.3
...
add address=177.72.104.4/27 comment="IP PUBLICO NAT CCR" interface=\
...
add action=src-nat chain=srcnat comment="NAT GERAL" out-interface=\
    vlan16-PUBLICA src-address-list=NAT-PRIVADAS to-addresses=177.72.104.4
add action=dst-nat chain=dstnat comment="DUDE - era .1:18291" dst-port=18291 \
    protocol=tcp to-addresses=192.168.116.30 to-ports=8291
add action=dst-nat chain=dstnat comment="TS SIX - era .1:15389" dst-port=\
    15389 protocol=tcp to-addresses=192.168.66.14 to-ports=15389
/ip ipsec profile
